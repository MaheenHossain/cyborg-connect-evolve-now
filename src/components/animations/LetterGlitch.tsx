...
const LetterGlitch = ({
  ...
  return (
    <div className="absolute inset-0 w-full h-full bg-black overflow-hidden" style={{ zIndex: -1 }}>
      <canvas ref={canvasRef} className="block w-full h-full" />
      {outerVignette && <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(0,0,0,0) 60%, rgba(0,0,0,1) 100%)' }}></div>}
      {centerVignette && <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(circle, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0) 60%)' }}></div>}
    </div>
  );
};
